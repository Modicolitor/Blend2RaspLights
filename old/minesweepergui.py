...
class Game(object):
    def __init__(self, w=20, h=20, mine_density=0.14):
        ...
        self.mine_locations = set((random.randrange(self.h), random.randrange(
            self.w)) for _ in range(int(self.w*self.h*self.mine_density)))
...
class MinesweeperGUI(GUI):
    def __init__(self, **kwargs):
        ...
        self.mine_density_slider = FloatSlider(
            value=self.game.mine_density, min=0, max=1)
